 ...
 */
@Data
public class OcpxSecondCvTypeVoListStruct {
  ...
  public OcpxSecondCvTypeVoListStruct id(Integer id) {
    this.id = id;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct cvType(Integer cvType) {
    this.cvType = cvType;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct bidType(Integer bidType) {
    this.bidType = bidType;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct cvTypeName(String cvTypeName) {
    this.cvTypeName = cvTypeName;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct cvTypePrice(Double cvTypePrice) {
    this.cvTypePrice = cvTypePrice;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct cvTypeThreshold(Integer cvTypeThreshold) {
    this.cvTypeThreshold = cvTypeThreshold;
    return this;
  }

  public OcpxSecondCvTypeVoListStruct cvTypeMaxPrice(Double cvTypeMaxPrice) {
