 ...
 */
@Data
public class CvTypeDetailStruct {
  ...
  public CvTypeDetailStruct id(Integer id) {
    this.id = id;
    return this;
  }

  public CvTypeDetailStruct cvType(Integer cvType) {
    this.cvType = cvType;
    return this;
  }

  public CvTypeDetailStruct bidType(Integer bidType) {
    this.bidType = bidType;
    return this;
  }

  public CvTypeDetailStruct cvTypeName(String cvTypeName) {
    this.cvTypeName = cvTypeName;
    return this;
  }

  public CvTypeDetailStruct cvTypePrice(Double cvTypePrice) {
    this.cvTypePrice = cvTypePrice;
    return this;
  }

  public CvTypeDetailStruct cvTypeThreshold(Integer cvTypeThreshold) {
    this.cvTypeThreshold = cvTypeThreshold;
    return this;
  }

  public CvTypeDetailStruct cvTypeMaxPrice(Double cvTypeMaxPrice) {
