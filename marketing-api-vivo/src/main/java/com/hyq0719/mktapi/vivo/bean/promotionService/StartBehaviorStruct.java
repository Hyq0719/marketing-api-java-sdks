 ...
 */
@Data
public class StartBehaviorStruct {
  ...
  public StartBehaviorStruct period(Integer period) {
    this.period = period;
    return this;
  }

  public StartBehaviorStruct behavior(Integer behavior) {
    this.behavior = behavior;
    return this;
  }

  public StartBehaviorStruct appCategoryCode(Set appCategoryCode) {
    this.appCategoryCode = appCategoryCode;
    return this;
  }

  public StartBehaviorStruct gameCategoryCode(Set gameCategoryCode) {
