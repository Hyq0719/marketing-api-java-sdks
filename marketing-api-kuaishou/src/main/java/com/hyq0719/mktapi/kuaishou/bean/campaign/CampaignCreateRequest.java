...
public class CampaignCreateRequest implements TokenKey {
  ...
  public CampaignCreateRequest type(Integer type) {
    this.type = type;
    return this;
  }
  ...
  public CampaignCreateRequest dayBudget(Long dayBudget) {
    this.dayBudget = dayBudget;
    return this;
  }

  public CampaignCreateRequest dayBudgetSchedule(List<Long> dayBudgetSchedule) {
